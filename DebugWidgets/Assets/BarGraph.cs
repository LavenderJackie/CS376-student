...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        signedDisplay = (Min < 0 || Max <= 0);
        if (signedDisplay) {
            var temp = BarTransform.localPosition;
            temp.x = width / 2;
            BarTransform.localPosition = temp;
        }
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        var temp = BarTransform.localScale;
        temp.x = (signedDisplay ? .5f * value : value);
